...
})(window,document,'script','dataLayer','GTM-WLGLQTP');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WLGLQTP"
		...
		<?php if ( (get_theme_mod('moesia_banner') == 1 && is_front_page()) ||  (get_theme_mod('moesia_banner') != 1)) : ?>
			...
			<div class="welcome-info">
				...
				<?php elseif ( get_theme_mod('header_title') ) : ?>
					<div class="welcome-title wow bounceInDown"><?php echo esc_html(get_theme_mod('header_title')); ?></div>
				<?php endif; ?>
