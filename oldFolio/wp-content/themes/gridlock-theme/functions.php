...
<div class="wrap">
	<div id="gridlock-div">
		...
		<div id="gridlockCaption">
			<p><strong>Gridlock 1.5</strong> (Build 1) &copy; 2005-2007 Eston Bond. Some rights reserved.</p>
...
function gridlock_dropdown_cats() {
  
}


// maintaining this old function for <2.3 reverse compatibility.
function old_gridlock_dropdown_cats($optionall = 1, $all = 'All', $sort_column = 'ID', $sort_order = 'asc',
